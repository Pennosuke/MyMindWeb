...
export default class TopFloor extends Component {
  render() {
    ...
    return (
      <View
        ...
        {Array.apply(null, Array(imageIterations)).map(( el, idx) => {
          ...
          return (
            <View key={idx}>
              <View style={{ width: height, height: height - 5, backgroundColor: '#c2673a' }}/>
              <View style={{ width: height, height: 5, backgroundColor: '#7c3100' }}/>
            </View>
          )
        })}
      </View>
