...
import { suicidalTestPart1 } from '../constants/แบบประเมินการฆ่าตัวตาย';
...
const survey = suicidalTestPart1
...
export default class SurveyQ1 extends Component {
  ...
  onSurveyFinished(answers) {
    ...
    const Q1 = answersAsObj.Q_1 + answersAsObj.Q_2

    if(Q1 > 0) {
      this.props.navigation.navigate('SurveyQ2', { surveyAnswers: answersAsObj, database : db });
    } else {
